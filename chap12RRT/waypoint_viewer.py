...
from message_types.msg_map import Building
...
class waypoint_viewer():
    ...
    def drawMap(self, map_):
        ...
        for i in range(0, map_.num_city_blocks):
            for j in range (0, map_.num_city_blocks):
                mesh, meshColors, building = self.buildingVertFace(map_.building_north.item(i),
    ...
    def buildingVertFace(self, n, e, width, height):
        building = Building(height, width, n, e)
        ...
        meshColors[8] = yellow
        meshColors[9] = yellow
        return mesh, meshColors, building
